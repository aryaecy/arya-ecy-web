...
V2.4.2, V2.4.1'in tum ozelliklerini korur ve Calisanlar ile Taseron Calisanlar icin Excel'den toplu veri yukleme ekler.
...
GitHub reposunda V2.4.2 dosyalarini V2.4.1 dosyalarinin uzerine yukleyin. package.json'da Excel okuma icin `xlsx` bagimliligi eklenmistir. Vercel yeni build'de otomatik kurar.
