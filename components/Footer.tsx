const ext=' ↗';
export default function Footer(){return <footer className="final-footer" id="iletisim">
  <nav className="footer-nav">
    <a href="/#hakkimizda">Hakkımızda</a><a href="/hizmetler">Hizmetler</a><a href="/kutuphane">Kütüphane</a><a href="/mevzuat">Mevzuat</a><a href="mailto:arya@aryaecy.com">İletişim</a><a href="#">ARYA AI</a>
  </nav>
  <div className="footer-bottom">
    <a className="mail" href="mailto:arya@aryaecy.com">✉ arya@aryaecy.com</a>
